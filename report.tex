...
% ---- Declaration / project information page ----
\thispagestyle{plain}
\noindent\rule{\textwidth}{0.4pt}

\vspace{1.5em}
\noindent{\Large\bfseries Report for Endterm Dual Degree Project}

\vspace{0.4em}
\noindent\textbf{Interdisciplinary Dual Degree: Robotics, IIT Madras}

\vspace{3em}

\noindent
\begin{tabular}{@{}p{0.6cm} p{5.5cm} p{0.3cm} p{8.5cm}@{}}
1. & \textbf{Name of the Student}        & : & Vaidehi Bagaria \\[1em]
2. & \textbf{Registration Number}        & : & ED21B070 \\[1em]
3. & \textbf{Registered for}             & : & B.Tech Engineering Design + M.Tech IDDD Robotics \\[1em]
4. & \textbf{Name(s) of the Supervisor}  & : & Prof. Bijo Sebastian \\
\end{tabular}
...
\centering
\textsc{Vaidehi Bagaria}\\[0.3em]
\textit{Signature of the student}
\end{minipage}
\hfill
\begin{minipage}[t]{0.45\textwidth}
\centering
\textsc{Prof. Bijo Sebastian}\\[0.3em]
\textit{Signature of the advisor}
\end{minipage}

\vspace{2em}
\begin{flushright}
\textit{This work is submitted to IROS 2026.}
\end{flushright}
...
I would like to thank Prof. Niravkumar Patel for his ideas and guidance throughout the project.
